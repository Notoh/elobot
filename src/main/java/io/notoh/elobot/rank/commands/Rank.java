...
public class Rank extends Command {
    ...
    public void run(Message msg) {
        ...
        msg.getChannel().sendMessage(name + " has rank " + rank + " with a rating of " + rating + " with a KDA of " +
                Util.DECIMAL_FORMAT.format(player.getKDA()) + " and a W/L of " + player.getWins() + "/" + player.getLosses() + " (" +
                Util.DECIMAL_FORMAT.format(player.getWinPct()*100) + "%)").queue();
    }
}
